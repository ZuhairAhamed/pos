...
class SubtotalCalculatorTest {
    ...
    private MenuCache cacheWith(String sku, String cat, String price) {
        return new MenuCache(List.of(new ProductView(sku, sku, cat, null, new BigDecimal(price), true, true)));
    }
    ...
    void categoriesAreDistinctInOrderWithOtherFallback() {
        MenuCache cache = new MenuCache(List.of(
                new ProductView("A", "A", "Mains", null, new BigDecimal("1"), true, true),
                new ProductView("B", "B", "Mains", null, new BigDecimal("1"), true, true),
                new ProductView("C", "C", null, null, new BigDecimal("1"), true, true)));
    ...
    void blankCategoryMapsToOther() {
        MenuCache cache = new MenuCache(List.of(
                new ProductView("A", "A", "  ", null, new BigDecimal("1"), true, true)));
    ...
    void nameForReturnsProductNameOnHit() {
        MenuCache cache =
                new MenuCache(List.of(new ProductView("BURGER", "Cheeseburger", "Mains", null, new BigDecimal("25.00"), true, true)));
